...
| | Reproducible parameters | Troubleshoot a pipeline warning message and apply a params file to track our parameters. |20|
| | Break | |15 |
...
| | Apply additional arguments | Supply external arguments to a process that are not preset as pipeline parameters. ||
