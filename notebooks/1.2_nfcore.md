...
The [nf-core YouTube channel](https://www.youtube.com/c/nf-core) is also especially helpful. There are lots of great workshops and ByteSize seminars for developers and users.
...
nf-core tools are for everyone and has commands to help both users and developers. For users, the tools make it easier to run workflows. For developers, the tools make it easier to develop and test your workflows using best practices. You can read about the nf-core commands on the [tools page](https://nf-co.re/tools/) of the nf-core website or using the command line.
