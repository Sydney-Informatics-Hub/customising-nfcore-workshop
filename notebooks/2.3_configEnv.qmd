...
<span style="color:#000080;"> Setting these values to the maximum or near-maximum on your machine/node is an important customisation to prevent unnecessary failed runs.</span>  
...
:bulb: Hint: the Nimbus training VM 'instance flavour' is 'c2r8' i.e. 2 CPU and 8 GB RAM. See the [Pawsey Nimbus nf-core config documentation](https://github.com/nf-core/configs/blob/master/docs/pawsey_nimbus.md) for help. 
:::
