...
You will be writing these files using **Nextflow** and **YAML** languages and also running some Nextflow commands and custom **Bash** code to efficiently extract information from the source code :nerd_face:. 
