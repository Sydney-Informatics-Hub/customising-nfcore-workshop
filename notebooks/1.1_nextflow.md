...
Pin the version of Nextflow to `22.10.1` using the `NXF_VER` environmental variable and check that it has been applied.
...
If you exported a version of Nextflow that was different to the version you are currently using Nextflow will automatically pull and install the version you exported.
