...
A [sample sheet](https://nf-co.re/rnaseq/3.11.1/usage#samplesheet-input) is a standard input requirement for nf-core pipelines. This sheet specifies input files, sample name, and sometimes other metadata for each sample being processed. 
