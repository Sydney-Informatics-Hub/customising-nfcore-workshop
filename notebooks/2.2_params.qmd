...
Nextflow accepts either YAML or JSON formats for parameter files. Any of the pipeline-specific [parameters](https://nf-co.re/rnaseq/3.11.1/parameters) can be supplied to a Nextflow pipeline in this way. 
...
:light_bulb: YAML formatting tips!

* strings need to be inside double quotes 
* booleans represented as true/false do not require quotes 
