...
::: callout-tip
### **Poll question!**
:question: For maintaining portability and reproducibility, what is the best way to specify our custom Trim Glaore container when we execute the nf-core/rnaseq pipeline? 
...
b) Within a separate custom config file named `custom-tools.config`. We would then apply it at `-c` along with our institutional config. 
