...
-	Select the box for `Trust the authors of all files in the parent folder ‘home’` then click `Yes, I trust the authors`
-	To open a terminal, from the top ribbon options, select `Terminal` --> `New Terminal` 
