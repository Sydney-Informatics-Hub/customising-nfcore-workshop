...
Connect to your instance with VS code by adding the host details to your `.ssh` config file:
  ...
  4. Select `Remote-SSH: Connect to Host` and select `Open SSH configuraiton file` 
...
1. The assigned IP address of your instance (i.e. 146.118.XXX.XX). Each participant will be provided with their instance’s IP address at the beginning of the workshop.
